...
MOCK_MATCHES = [
    {
        "id": "mock-001",
        "competition": "2026 FIFA 世界杯 · 1/8 决赛",
        "date": "2026-06-30",
        "time": "09:00",
        "venue": "梅赛德斯奔驰体育场，亚特兰大",
        "home": {
            "name": "巴西", "short": "BRA",
            "form": ["胜", "胜", "平", "胜", "胜"],
            "league_pos": 1,
        ...
        "h2h": {"home_win": 2, "draw": 1, "away_win": 2, "avg_goals": 2.8},
        "injuries": {
            "home": [{"player": "内马尔", "reason": "膝伤恢复", "status": "出战成疑"}],
            "away": [{"player": "梅西", "reason": "腿筋不适", "status": "大概率出场"}],
        },
        "odds": {"home_win": 2.55, "draw": 3.20, "away_win": 2.75},
    },
    {
        "id": "mock-002",
        "competition": "2026 FIFA 世界杯 · 1/8 决赛",
        ...
        "h2h": {"home_win": 3, "draw": 1, "away_win": 1, "avg_goals": 2.5},
        "injuries": {
            "home": [{"player": "姆巴佩", "reason": "脚踝疲劳", "status": "健康"}],
            "away": [{"player": "凯恩", "reason": "背部不适", "status": "出战成疑"}],
        },
        "odds": {"home_win": 2.10, "draw": 3.10, "away_win": 3.40},
    },
]
